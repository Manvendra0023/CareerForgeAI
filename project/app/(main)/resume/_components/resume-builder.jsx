...
import ResumeSecurityScanner from "./resume-security-scanner";
...
export default function ResumeBuilder({ initialContent }) {
  ...
  return (
    <div data-color-mode="light" className="space-y-4">
      ...
      {/* RESUME SECURITY SCANNER */}
      <div className="border rounded-xl p-4 bg-muted/30">
        <ResumeSecurityScanner resumeContent={previewContent} />
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="preview">
          ...
          {/* HIDDEN PDF AREA - removed from here, now outside Tabs */}
        </TabsContent>
      </Tabs>

      {/* HIDDEN PDF AREA - always in DOM so PDF works from any tab */}
